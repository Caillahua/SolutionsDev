...
public class ShowCameraActivity extends Activity implements OnClickListener {
    ...
    private void setHasFlash(Boolean hasFlash) {
        ...
        if (!hasFlash) {
            ...
            AlertDialog alert = new AlertDialog.Builder(ShowCameraActivity.this)
                    .create();
    ...
    protected void onResume() {
        ...
        if (mCamera == null) {
            ...
            preview = new ShowCamera(this, mCamera);
...
//                    captureImage();
                ...
                break;
            case R.id.btn_flash:
                //Toast.makeText(act, "Flash", Toast.LENGTH_SHORT).show();
                    ...
                    if (heigth > 4500) {
                        ...
                        if (heigth > 2500) {
                            ...
                            if (heigth > 1500) {
                                ...
                                ImagePicker.saveToChangesToExternalCacheDir(rotateImage(mBitmap, rotationDegrees), ShowCameraActivity.this, 100);
                            }
                        }
