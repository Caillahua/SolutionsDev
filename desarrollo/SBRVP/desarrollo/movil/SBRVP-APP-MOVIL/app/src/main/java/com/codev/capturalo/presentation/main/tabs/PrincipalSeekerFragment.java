...
public class PrincipalSeekerFragment extends BaseFragment implements MenuItem.OnActionExpandListener, MainContract.View,
    ...
    public PrincipalSeekerFragment() {
        // Requires empty public constructor
    }

    public static PrincipalSeekerFragment newInstance() {
        return new PrincipalSeekerFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_principal_seeker, container, false);
        ButterKnife.bind(this, root);

        toolbar.setTitle(R.string.artist_explorer);

        mProgressDialogCustom = new ProgressDialogCustom(getContext(), "Buscando...");
